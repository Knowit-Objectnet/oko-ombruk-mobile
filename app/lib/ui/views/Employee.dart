  ...
  actionItems: [
    ActionItem(
      ...
      callback: (actionKey) {
        ...
        // Change icon
        Icon icon = Icon(key.currentState.verticalCalendar ? Icons.list :  Icons.calendar_today);
    ...
    ActionItem(
      ...
      callback: (actionKey) {
        // Push screen
        Navigator.push(actionKey.currentContext, MaterialPageRoute(builder: (context) => AddExtraPickupScreen()));
      }
    )
  ]
);
